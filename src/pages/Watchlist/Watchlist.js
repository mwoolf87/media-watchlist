    ...
    <div>
      ...
      String(local.getItem("last")) === "null" ? (
        <div>
          ...
          <div>
            <a id = "blueLink" href = "https://mwl-backend-v2.herokuapp.com/login">Login</a> or create an <a id = "blueLink" href = "https://media-watch-list.herokuapp.com/login">account</a> to save movies to watchlist</div>
        </div>
      ) : (
        <h1>
